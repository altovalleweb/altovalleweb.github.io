class MapService {
  ...
  static async saveLayer(zonaId, zonaLayer) {
    try {
      ...
      const result = await fetch(
        "https://crossorigin.me/www.foodchoice.es/foodchoicebe/rest/WSGuardaZona",
        {
          method: "POST",
          body: bodyRequest,
          headers: {
 ...
 static getLayer(zonaId) {
    ...
    return fetch("https://crossorigin.me/www.foodchoice.es/foodchoicebe/rest/WSDevuelveZonas", {
      method: "POST",
      body: bodyRequest,
      headers: {
        "Content-type": "application/json",
